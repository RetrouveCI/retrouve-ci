...
import { ActivityChart } from '@/app/admin/(dashboard)/components/activity-chart'
import { CategoryChart } from '@/app/admin/(dashboard)/components/category-chart'
import { RecentActivity } from '@/app/admin/(dashboard)/components/recent-activity'
