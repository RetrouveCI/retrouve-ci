...
export function FeatureCard({
	...
	return (
		<div className="group glass-effect elevated-card relative rounded-2xl border border-white/20 p-4 shadow-sm transition-all duration-300 hover:shadow-lg md:p-6">
			...
			<div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[var(--primary-green)]/0 to-[var(--accent-orange)]/0 transition-all duration-300 group-hover:from-[var(--primary-green)]/5 group-hover:to-[var(--accent-orange)]/5" />
