      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-[var(--primary-green)]/5 blur-3xl" />
            <div className="absolute -bottom-20 -left-20 w-80 h-80 rounded-full bg-[var(--accent-orange)]/5 blur-3xl" />
          </div>
          ...
          <div className="container mx-auto px-4 pt-12 pb-8 relative">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="relative max-w-xl mx-auto">
                <div className="flex items-center gap-2 px-4 rounded-2xl border-2 bg-background shadow-sm focus-within:border-[var(--primary-green)]/50 transition-all">
                  ...
                  <Input
                    ...
                    className="border-0 bg-transparent h-12 focus-visible:ring-0 focus-visible:ring-offset-0 px-0 text-sm md:text-base"
                  />
                  {searchQuery && (
                    <button
                      onClick={() => {
            ...
            >
              ...
              <div className="flex flex-col gap-3 mb-5">
                <div className="flex flex-wrap items-center gap-3">
                  {/* Tabs */}
                  <TabsList className="h-10 p-1 rounded-xl bg-muted/60">
                    <TabsTrigger
                      value="all"
                    ...
                    <TabsTrigger
                      ...
                      className="rounded-lg px-4 text-sm data-[state=active]:bg-background data-[state=active]:shadow-sm"
                    >
                      <span className="w-2 h-2 rounded-full bg-[var(--primary-green)] mr-1.5" />
                      Retrouvés
                    </TabsTrigger>
                  </TabsList>
                  ...
                  <div className="flex items-center gap-2 ml-auto">
                    ...
                    <button
                      ...
                      className={cn(
                        "flex items-center gap-1.5 h-10 px-3.5 rounded-xl text-sm font-medium border transition-all",
                        showFilters || activeFiltersCount > 0
                          ? "bg-[var(--primary-green)]/10 border-[var(--primary-green)]/40 text-[var(--primary-green)]"
                    ...
                    >
                      ...
                      {activeFiltersCount > 0 && (
                        <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[var(--primary-green)] text-white text-[10px] font-bold">
                          {activeFiltersCount}
                        </span>
                      )}
                    </button>
                    ...
                    {/* View toggle */}
                    <div className="flex items-center gap-0 border rounded-xl overflow-hidden bg-background p-0.5">
                      <button
                    ...
                    {categories.map(({ id, label, icon: Icon }) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-medium transition-all whitespace-nowrap border",
                            isActive
              ...
              {activeChips.length > 0 && (
                <div className="flex flex-wrap items-center gap-2 mb-4">
                  ...
                  {activeChips.map((chip) => (
                    <span
                      key={chip.label}
                      className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--primary-green)]/10 text-[var(--primary-green)] text-xs font-medium border border-[var(--primary-green)]/20"
                    >
                      {chip.label}
                      <button
              ...
              {/* Filter panel */}
              {showFilters && (
                <div className="mb-5 p-5 rounded-2xl border-2 border-dashed border-[var(--primary-green)]/20 bg-[var(--primary-green)]/3">
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-sm font-semibold flex items-center gap-2">
                      <SlidersHorizontal className="w-4 h-4 text-[var(--primary-green)]" />
                      Filtres avancés
                    </p>
                    {activeFiltersCount > 0 && (
                      <button
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <button
                            className={cn(
                              "w-full h-10 flex items-center gap-2 rounded-xl border bg-background px-3 text-sm transition-colors hover:bg-muted/50",
                              dateRange?.from
                                ? "text-foreground"
