					...
					<div className="flex min-w-0 flex-1 flex-col justify-between">
						<div>
							<div className="mb-1 flex items-start justify-between gap-2">
								<h3 className="line-clamp-1 text-sm leading-snug font-semibold transition-colors group-hover:text-primary-green">
									{listing.title}
								</h3>
								<span
									className={cn(
						...
						<div className="text-muted-foreground mt-2 flex items-center gap-3 text-xs">
							...
							<span className="ml-auto flex items-center gap-1 font-medium text-primary-green opacity-0 transition-opacity group-hover:opacity-100">
			...
			<article className="bg-background relative flex h-full flex-col overflow-hidden rounded-2xl border transition-all duration-300 hover:-translate-y-0.5 hover:border-primary-green/30 hover:shadow-lg">
				...
				<div className="flex flex-1 flex-col p-3">
					...
					<div className="flex items-center justify-between border-t pt-2.5">
						...
						<span className="flex translate-x-0 items-center gap-1 text-xs font-semibold text-primary-green transition-transform group-hover:translate-x-0.5">
							Voir
