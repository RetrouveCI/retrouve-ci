...
const TEMPLATES: Record<OtpPurpose, (code: string) => string> = {
	'sign-in': code =>
		`Votre code de verification RetrouveCI est ${code}. Il expire dans 5 minutes. Ne le partagez avec personne.`,
	'password-reset': code =>
		`Votre code de reinitialisation RetrouveCI est ${code}. Il expire dans 5 minutes. Ne le partagez avec personne.`,
}
