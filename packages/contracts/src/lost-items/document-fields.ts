import type { DocumentType } from './enums.schema'
import { BANK_CARD_DIGITS, DOCUMENT_TYPES } from './lost-items.const'

/**
 * What each piece of ID is called and what it asks for, shared by both
 * front-ends: the public form and the backoffice's team publication ask the
 * same questions, so a piece filed at the desk reads like one a visitor filed.
 * Keying by `DocumentType` turns a type added here into a compilation error
 ...
 */
export const CI_BANKS: readonly string[] = [
	'Access Bank',
	'Afriland First Bank',
	'Banque Atlantique',
	'Banque Populaire',
...
export const CI_INSURERS: readonly string[] = [
	'Activa Assurances',
	'Allianz',
	'Amsa Assurances',
