	...
	return (
		<section className="relative overflow-hidden border-b">
			<div className="pointer-events-none absolute inset-0">
				<div className="bg-primary-green/5 absolute -top-20 right-0 h-125 w-125 rounded-full blur-3xl" />
					...
					<div className="flex flex-col items-center gap-10 md:flex-row md:gap-16">
						<div className="flex-1 text-center md:text-left">
							...
							<div className="flex flex-wrap justify-center gap-3 md:justify-start">
								<Button
									asChild
									size="lg"
									className="bg-primary-green hover:bg-primary-green-dark h-12 px-6 text-white"
								>
						...
						<div className="relative shrink-0">
							<div className="relative h-52 w-52 md:h-64 md:w-64">
								<div className="from-primary-green/20 to-accent-orange/10 absolute inset-0 rotate-6 rounded-3xl bg-linear-to-br" />
								<div className="bg-background absolute inset-0 flex items-center justify-center rounded-2xl border shadow-xl">
									<div className="text-center">
										<QrCode className="text-primary-green mx-auto mb-3 h-20 w-20 md:h-28 md:w-28" />
										<p className="text-muted-foreground text-xs font-medium">
											RCI-XXXX-XXXX
										</p>
									</div>
								</div>
								<div className="bg-accent-orange absolute -right-3 -bottom-3 flex h-14 w-14 items-center justify-center rounded-xl shadow-lg">
