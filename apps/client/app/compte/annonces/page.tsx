      ...
      <main className="flex-1">
        ...
        <section className="relative border-b overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute -top-20 right-0 w-96 h-96 rounded-full bg-[var(--accent-orange)]/5 blur-3xl" />
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl bg-[var(--accent-orange)]/10 flex items-center justify-center">
                  <FileText className="w-7 h-7 text-[var(--accent-orange)]" />
                </div>
                <div>
              ...
              <Button
                asChild
                className="bg-[var(--accent-orange)] hover:bg-[var(--accent-orange-dark)] text-white rounded-xl gap-2"
              >
                <Link href="/publier">
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            {filteredListings.length > 0 ? (
              ...
              <div className="rounded-2xl border-2 border-dashed bg-muted/30 py-12 text-center">
