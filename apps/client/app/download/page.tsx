			...
			<main className="flex-1">
				...
				<section className="relative overflow-hidden border-b">
					<div className="pointer-events-none absolute inset-0">
						<div className="absolute -top-32 -right-32 h-[500px] w-[500px] rounded-full bg-(primary-green)/6 blur-3xl" />
						...
						<div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-2">
							...
							<div className="text-center md:text-left">
								...
								<div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:justify-start">
									...
									<button
										disabled
										className="flex cursor-not-allowed items-center gap-3 rounded-xl bg-(primary-green) px-5 py-3 text-white opacity-60"
									>
								...
								<div className="relative">
									<div className="bg-foreground relative h-[520px] w-[260px] rounded-[2.8rem] p-3 shadow-2xl">
										<div className="bg-background relative h-full w-full overflow-hidden rounded-[2.3rem]">
											...
											<div className="flex h-full flex-col gap-3 px-4 pt-9 pb-4">
												...
												{/* Scanner */}
												<div className="bg-muted/40 flex flex-1 flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-(primary-green)/30">
													...
													{/* Scan corners */}
													<div className="pointer-events-none absolute top-16 left-16 h-16 w-16 rounded-tl-lg border-t-2 border-l-2 border-(primary-green)" />
													<div className="pointer-events-none absolute top-16 right-16 h-16 w-16 rounded-tr-lg border-t-2 border-r-2 border-(primary-green)" />
												</div>
												{/* Notification pill */}
												<div className="flex items-center gap-2 rounded-xl border border-(primary-green)/20 bg-(primary-green)/10 px-3 py-2">
													<CheckCircle2 className="h-4 w-4 shrink-0 text-(primary-green)" />
									...
									<div className="bg-background animate-float absolute top-24 -left-14 rounded-xl border p-2.5 shadow-lg">
										<div className="flex items-center gap-2">
											<div className="flex h-7 w-7 items-center justify-center rounded-lg bg-(primary-green)/10">
				...
				<section className="py-16 md:py-24">
					<div className="container mx-auto px-4">
						...
						<div className="mx-auto grid max-w-5xl grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{/* Large — Scan QR */}
							<div className="group bg-background rounded-2xl border p-8 transition-all duration-300 hover:border-(primary-green)/40 hover:shadow-lg sm:col-span-2">
								<div className="mb-6 flex items-start justify-between">
									<div className="flex h-12 w-12 items-center justify-center rounded-xl bg-(primary-green)/10 transition-transform duration-300 group-hover:scale-110">
										<QrCode className="h-6 w-6 text-(primary-green)" />
									</div>
							...
							{/* Notifications */}
							<div className="group bg-background rounded-2xl border p-6 transition-all duration-300 hover:border-(accent-orange)/40 hover:shadow-lg">
								<div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-(accent-orange)/10 transition-transform duration-300 group-hover:scale-110">
							...
							{/* Shield */}
							<div className="group bg-background rounded-2xl border p-6 transition-all duration-300 hover:border-(primary-green)/40 hover:shadow-lg">
								<div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-(primary-green)/10 transition-transform duration-300 group-hover:scale-110">
							...
							<div className="group rounded-2xl border bg-(primary-green) p-6 text-white transition-all duration-300 hover:shadow-lg">
							...
							{/* Rating */}
							<div className="group bg-background flex flex-col justify-between rounded-2xl border p-6 transition-all duration-300 hover:border-(accent-orange)/40 hover:shadow-lg">
								<div className="mb-4 flex items-center gap-1">
									{[...Array(5)].map((_, i) => (
										<Star
											key={i}
											className="h-5 w-5 fill-(accent-orange) text-(accent-orange)"
										/>
									))}
								</div>
						...
						<div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
							{[
								...
								>
									...
									<div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-(primary-green)/10">
										<item.icon className="h-6 w-6 text-(primary-green)" />
									</div>
				...
				<section className="py-16 md:py-24">
					<div className="container mx-auto px-4">
						<div className="bg-background relative mx-auto max-w-2xl overflow-hidden rounded-2xl border p-10 text-center">
							<div className="pointer-events-none absolute -top-16 -right-16 h-48 w-48 rounded-full bg-(primary-green)/5 blur-2xl" />
							<div className="mb-5 inline-flex items-center gap-2 rounded-full border border-(accent-orange)/20 bg-(accent-orange)/10 px-3 py-1 text-xs font-medium text-(accent-orange)">
							...
							<div className="flex flex-col justify-center gap-3 sm:flex-row">
								<Button
									asChild
									size="lg"
									className="h-11 rounded-xl bg-(primary-green) px-6 text-white hover:bg-(primary-green-dark)"
								>
