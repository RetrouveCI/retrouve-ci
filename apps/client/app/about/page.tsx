		...
		<>
			...
			<main className="flex-1">
				...
				<section className="relative overflow-hidden border-b">
					...
					<div className="absolute -top-24 right-0 h-80 w-80 rounded-full bg-[var(--primary-green)]/8 blur-3xl" />
						...
						<div className="grid grid-cols-2 gap-6 md:grid-cols-4">
							{stats.map(s => (
								<div key={s.label} className="text-center">
									<p className="text-2xl font-bold text-[var(--primary-green)] md:text-3xl">
										{s.value}
									</p>
					...
					<div className="container mx-auto px-4">
						<div className="grid gap-4 md:grid-cols-12">
							...
							<div className="bg-background flex min-h-64 flex-col justify-between rounded-2xl border p-8 md:col-span-7">
								<div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--primary-green)]/10">
									<Heart className="h-6 w-6 text-[var(--primary-green)]" />
								</div>
								<div>
							...
							{/* Founded card */}
							<div className="flex min-h-48 flex-col justify-between rounded-2xl border bg-[var(--primary-green)] p-8 text-white md:col-span-5">
							...
							<div className="bg-background flex flex-col gap-4 rounded-2xl border p-8 md:col-span-4">
								<div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--accent-orange)]/10">
									<QrCode className="h-6 w-6 text-[var(--accent-orange)]" />
								</div>
								<div>
					...
					<div className="container mx-auto px-4">
						...
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
							{team.map(member => (
								...
								>
									<div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[var(--primary-green)]/10 transition-colors group-hover:bg-[var(--primary-green)]/20">
				...
				<section className="border-t py-12">
					<div className="container mx-auto px-4">
						<div className="flex flex-col items-center justify-between gap-6 rounded-2xl bg-[var(--primary-green)] p-8 text-white md:flex-row md:p-12">
							<div>
							...
							<Link
								href="/publier"
								className="inline-flex shrink-0 items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[var(--primary-green)] transition-colors hover:bg-white/90"
							>
								Publier une annonce
