	...
	return (
		<section className="relative overflow-hidden border-b">
			...
			<div className="relative container mx-auto max-w-2xl px-4 py-14 text-center md:py-20">
				<div className="border-accent-orange/20 bg-accent-orange/10 text-accent-orange-text mb-5 inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-semibold">
